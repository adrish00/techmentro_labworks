...
public class SaveClientObjectValuedNonIndexedCollection {

	public SaveClientObjectValuedNonIndexedCollection() {
	...
	public static void main(String[] args) {
		...
		javabatches.add(csh);
		javabatches.add(asp_net);
		
		Trainer javaTrainer = new Trainer("Anil", javabatches);
		Trainer dotNetTrainer = new Trainer("Saurav", dotnetbatches);
