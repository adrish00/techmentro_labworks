...
public class IOCUser {
	...
	public static void main(String[] args) {
		...
		Number n1 = (Number)factory.getBean("complex");
		Number n2 = (Number)factory.getBean("complex");
		Number n4 = (Number)factory.getBean("rational");
		Number n5 = (Number)factory.getBean("rational");
