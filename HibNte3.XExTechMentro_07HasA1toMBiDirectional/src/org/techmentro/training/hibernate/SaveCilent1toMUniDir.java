...
public class SaveCilent1toMUniDir {

	public SaveCilent1toMUniDir() {
	...
	public static void main(String[] args) {
		...
		Trainer javaTrainer = new Trainer("Neeraj Kumar", javabatches);
		Trainer dotNetTrainer = new Trainer("Ayon Chatterjee", dotnetbatches);
